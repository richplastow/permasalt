...
(function(ªG) {
/*! Permasalt 0.0.1 //// MIT Licence //// http://permasalt.richplastow.com/ */
var Permasalt, SomeClass, Tudor, tudor, xx, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªex, ªhas, ªinsert, ªis, ªisU, ªredefine, ªtype, ªuid,
...
SomeClass = (function() {
  ...
  function SomeClass(config) {
    ...
    M = "/permasalt/src/SomeClass/SomeClass.litcoffee SomeClass()\n  ";
    this.x = null;
  }

  SomeClass.prototype.xx = function(xx) {
    var M;
    return M = "/permasalt/src/SomeClass/SomeClass.litcoffee SomeClass.xx()\n  ";
  };
...
xx = function(xx) {
  var M;
  return M = "/permasalt/src/SomeClass/SomeClass.litcoffee xx()\n  ";
};

Permasalt = (function() {
  Permasalt.prototype.C = 'Permasalt';

  Permasalt.prototype.toString = function() {
    return '[object Permasalt]';
  };

  function Permasalt(config) {
    var M;
    if (config == null) {
      config = {};
    }
    M = "/permasalt/src/Permasalt.litcoffee Permasalt()\n  ";
    this.x = null;
  }

  Permasalt.prototype.xx = function(xx) {
    var M;
    return M = "/permasalt/src/Permasalt.litcoffee Permasalt.xx()\n  ";
  };
...
xx = function(xx) {
  var M;
  return M = "/permasalt/src/Permasalt.litcoffee xx()\n  ";
};
...
tudor.add([
  "01 Permasalt Constructor Usage", tudor.is, "The class and instance are expected types", "The Permasalt class is a function", ªF, function() {
    return Permasalt;
  }, "`new` returns an object", ªO, function() {
    return new Permasalt;
  }
]);
}).call(this,this);
// Example vendor file. 
